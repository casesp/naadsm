...
typedef struct
{
  ...
  const char *cause; /**< name of the model that created the event */
  gboolean traceable;
  gboolean traced;
  gboolean adequate;
  HRD_status_t override_initial_state; /**< when using an exposure event to
...
typedef struct
{
  ...
  const char *means_as_text; /**< how the unit was detected */
...
EVT_destruction_canceled_event_t;
...
typedef struct
{
  ...
  union
  {
    ...
    EVT_destruction_canceled_event_t destruction_canceled;
...
EVT_event_t *EVT_new_exposure_event (HRD_herd_t * exposing_herd,
                                     ...
                                     gboolean traceable,
                                     gboolean adequate);
EVT_event_t *EVT_new_infection_event (HRD_herd_t * herd, int day);
...
EVT_event_t *EVT_new_vaccination_event (HRD_herd_t *, int day,
                                        const char *reason,
                                        int day_commitment_made);
...
EVT_event_t *EVT_new_destruction_canceled_event (HRD_herd_t *, int day,
                                                 int day_commitment_made);
...
EVT_event_t *EVT_new_unit_state_change_event (HRD_herd_t *,
                                              HRD_status_t old_state,
                                              HRD_status_t new_state,
                                              int day);
