...
INSERT INTO DBSchemaVersion ( VersionNumber, VersionApplication, VersionDate, VersionID )
...
CREATE UNIQUE INDEX outDailyByProductionType_PK ON outDailyByProductionType ( productionTypeID, day, iteration, scenarioID, threadNo );
...
CREATE INDEX outDailyByProductionType_I3 ON outDailyByProductionType ( threadNo );


-- Primary key for table outDailyByZone:
CREATE UNIQUE INDEX outDailyByZone_PK ON outDailyByZone ( iteration, day, zoneID, scenarioID, threadNo );
...
CREATE INDEX outDailyByZone_I3 ON outDailyByZone ( threadNo );


-- Primary key for table outDailyByZoneAndProductionType:
CREATE UNIQUE INDEX outDailyByZoneAndProductionType_PK ON outDailyByZoneAndProductionType ( day, iteration, zoneID, productionTypeID, scenarioID, threadNo );
...
CREATE INDEX outDailyByZoneAndProductionType_I3 ON outDailyByZoneAndProductionType ( threadNo );


-- Primary key for table outEpidemicCurves:
CREATE UNIQUE INDEX outEpidemicCurves_PK ON outEpidemicCurves ( iteration, day, productionTypeID, scenarioID, threadNo );
...
CREATE INDEX outEpidemicCurves_I3 ON outEpidemicCurves ( threadNo );


-- Primary key for table outGeneral:
CREATE UNIQUE INDEX outGeneral_PK ON outGeneral ( outGeneralID, scenarioID, threadNo );
...
CREATE INDEX outGeneral_I1 ON outGeneral ( threadNo );

-- Primary key for table outIteration:
CREATE UNIQUE INDEX outIteration_PK ON outIteration ( iteration, scenarioID, threadNo );
...
CREATE INDEX outIteration_I2 ON outIteration ( threadNo );


-- Primary key for table outIterationByProductionType:
CREATE UNIQUE INDEX outDailyEpiByProductionType_PK ON outIterationByProductionType ( iteration, productionTypeID, scenarioID, threadNo );
...
CREATE INDEX outIterationByProductionType_I2 ON outIterationByProductionType ( threadNo );


-- Primary key for table outIterationByZone:
CREATE UNIQUE INDEX outIterationByZone_PK ON outIterationByZone ( iteration, zoneID, scenarioID, threadNo );
...
CREATE INDEX outIterationByZone_I2 ON outIterationByZone ( threadNo );


-- Primary key for table outIterationByZoneAndProductionType:
CREATE UNIQUE INDEX outIterationByZoneAndProductionType_PK ON outIterationByZoneAndProductionType ( iteration, zoneID, productionTypeID, scenarioID, threadNo );
...
CREATE INDEX outIterationByZoneAndProductionType_I2 ON outIterationByZoneAndProductionType ( threadNo );
...
ALTER TABLE outDailyByProductionType
  ADD CONSTRAINT inScenario_outDailyByProductionType_FK FOREIGN KEY ( scenarioID )
