/** @file local-area-spread-model.c
 * Module for local area spread in which the probability of infection falls off
...
#define is_singleton local_area_spread_model_is_singleton
#define new local_area_spread_model_new
#define set_params local_area_spread_model_set_params
#define run local_area_spread_model_run
#define reset local_area_spread_model_reset
#define events_listened_for local_area_spread_model_events_listened_for
#define is_listening_for local_area_spread_model_is_listening_for
#define has_pending_actions local_area_spread_model_has_pending_actions
#define to_string local_area_spread_model_to_string
#define local_printf local_area_spread_model_printf
#define local_fprintf local_area_spread_model_fprintf
#define local_free local_area_spread_model_free
#define handle_before_any_simulations_event local_area_spread_model_handle_before_any_simulations_event
#define handle_new_day_event local_area_spread_model_handle_new_day_event
#define check_and_infect local_area_spread_model_check_and_infect
...
#include "local-area-spread-model.h"
...
#define MODEL_NAME "local-area-spread-model"
...
handle_before_any_simulations_event (EVT_event_queue_t * queue)
{
  ...
  g_ptr_array_add (causes, (gpointer) NAADSM_contact_type_abbrev[NAADSM_LocalAreaSpread]);
...
check_and_infect (int id, gpointer arg)
{
   ...
   * (Most event handlers will ignore exposures by local area spread,
   * which are not traceable). */
  day = callback_data->day;
  exposure = EVT_new_exposure_event (herd1, herd2, day,
                                     NAADSM_contact_type_abbrev[NAADSM_LocalAreaSpread],
                                     FALSE, exposure_is_adequate);
  exposure->u.exposure.contact_type = NAADSM_LocalAreaSpread;
...
/**
 * Adds a set of parameters to an local area spread model.
 */
void
...
/**
 * Returns a new local area spread model.
 */
naadsm_model_t *
...
/* end of file local-area-spread-model.c */
