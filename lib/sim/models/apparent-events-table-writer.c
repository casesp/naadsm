...
handle_before_any_simulations_event (struct naadsm_model_t_ * self)
{
  ...
  fprintf (local_data->stream, "Run,Day,Type,Reason,ID,Production type,Size,Lat,Lon\n");
