 ...
 * @date April 2004
 *
 * Copyright &copy; University of Guelph, 2004-2011
 * 
...
handle_new_day_event (struct naadsm_model_t_ *self)
{
  ...
  RPT_reporting_add_integer (local_data->unit_days_in_queue,
                             RPT_reporting_get_integer (local_data->nherds_awaiting_vaccination, NULL),
                             NULL);
  RPT_reporting_add_integer (local_data->animal_days_in_queue,
                             RPT_reporting_get_integer (local_data->nanimals_awaiting_vaccination, NULL),
                             NULL);
