...
#if DEBUG
  g_log (G_LOG_DOMAIN, G_LOG_LEVEL_DEBUG, "requesting quarantine of unit \"%s\"",
         herd->official_id);
#endif
     ...
     EVT_event_t * event, RAN_gen_t * rng, EVT_event_queue_t * queue)
{
  ...
  switch (event->type)
    ...
    case EVT_TraceResult:
      handle_trace_result_event (self, herds, &(event->u.trace_result));
      break;
    default:
      g_error
...
/* end of file trace-quarantine-model.c */
