...
#if DEBUG
  g_log (G_LOG_DOMAIN, G_LOG_LEVEL_DEBUG, "----- ENTER REL_new_point_chart");
#endif
...
#if DEBUG
  g_log (G_LOG_DOMAIN, G_LOG_LEVEL_DEBUG, "----- EXIT REL_new_point_chart");
#endif
...
REL_new_generic_chart (double *x, double *y, size_t n)
{
...
#if DEBUG
  g_log (G_LOG_DOMAIN, G_LOG_LEVEL_DEBUG, "----- ENTER REL_new_generic_chart");
#endif

  /* Remove duplicates (assuming points are ordered by x-value). */
#if DEBUG
  g_log (G_LOG_DOMAIN, G_LOG_LEVEL_DEBUG, "removing duplicate points");
#endif
  for (i = 0; i + 1 < n;)
    {
#if DEBUG
  ...
  g_log (G_LOG_DOMAIN, G_LOG_LEVEL_DEBUG, "chart now {%s}", s->str);
  g_string_free (s, TRUE);
#endif

  /* Remove collinear points. */
#if DEBUG
  g_log (G_LOG_DOMAIN, G_LOG_LEVEL_DEBUG, "removing collinear points");
#endif
  for (i = 0; i + 2 < n;)
    {
#if DEBUG
...
#if DEBUG
  g_log (G_LOG_DOMAIN, G_LOG_LEVEL_DEBUG, "----- EXIT REL_new_generic_chart");
#endif
  return chart;
}
...
#if DEBUG
  g_log (G_LOG_DOMAIN, G_LOG_LEVEL_DEBUG, "----- ENTER REL_new_chart");
#endif
...
#if DEBUG
  g_log (G_LOG_DOMAIN, G_LOG_LEVEL_DEBUG, "----- EXIT REL_new_chart");
#endif
...
#if DEBUG
  g_log (G_LOG_DOMAIN, G_LOG_LEVEL_DEBUG, "----- ENTER REL_chart_set_domain");
#endif
...
#if DEBUG
  g_log (G_LOG_DOMAIN, G_LOG_LEVEL_DEBUG, "----- EXIT REL_chart_set_domain");
#endif
  return;
}
...
#if DEBUG
  g_log (G_LOG_DOMAIN, G_LOG_LEVEL_DEBUG, "----- ENTER REL_chart_zero_at_right");
#endif
...
#if DEBUG
  g_log (G_LOG_DOMAIN, G_LOG_LEVEL_DEBUG, "----- EXIT REL_chart_zero_at_right");
#endif
