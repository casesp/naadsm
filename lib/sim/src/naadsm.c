...
current_version (void)
{
   ...
   */ 
  /* ALSO DON'T FORGET: When updating this version number, also update the version 
...
DLL_API void
set_cancel_herd_destruction (TFnVoid_1_THRDControl fn)
{
  naadsm_cancel_herd_destruction = fn; 
}
...
const char *NAADSM_contact_type_name[] = {
  ...
  "Initially Infected", "Local Area Spread", NULL
};

const char *NAADSM_contact_type_abbrev[] = {
  "Unkn", "Dir", "Ind", "Air", "Ini", "Lcl", NULL
};

const char *NAADSM_detection_reason_abbrev[] = {
  "Unkn", "Clin", "Test", "Dead", "DeadV", "DeadD", NULL
};

const char *NAADSM_control_reason_abbrev[] = {
  "Unkn", "Ring", "DirFwd", "IndFwd", "DirBack", "IndBack", "Det", "DetDead",
  "Ini", NULL
};
