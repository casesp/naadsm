 ...
 * @date June 2005
 *
 * Copyright &copy; 2005 - 2010 Animal Population Health Institute,
...
typedef enum {
  ...
  NAADSM_LocalAreaSpread
} NAADSM_contact_type;
#define NAADSM_NCONTACT_TYPES 6
...
typedef enum {
  ...
  NAADSM_DetectionDeadFromDisease,
...
typedef enum {
  ...
  NAADSM_ControlDetectionDeadFromDisease,
  NAADSM_ControlInitialState,
  NAADSM_ControlRoutine
} NAADSM_control_reason;
#define NAADSM_NCONTROL_REASONS 10
 ...
 * has occurred.
 *
 * Note that exposures precede infections by a day.
*/
typedef struct
{
...
TFnVoid_1_THRDControl naadsm_cancel_herd_destruction;
...
DLL_API void set_cancel_herd_destruction (TFnVoid_1_THRDControl fn);
