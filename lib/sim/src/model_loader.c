 ...
 *   CANADA
 *
 * Copyright &copy; University of Guelph, 2003-2013
 *
...
struct model_load_info_t model_list[] = {
  ...
  {"apparent-events-table-writer", (void*)&apparent_events_table_writer_new,
    apparent_events_table_writer_is_singleton},
  #endif
  {"basic-dcd-model", (void*)&basic_dcd_model_new, NULL},
  ...
  #endif
  #ifndef WIN_DLL
  /* NH 2010 Feb 8: if state-table-writer.c doesn't compile on Windows,
   * exposures-table-writer.c probably won't either. */
  ...
  #endif
  {"local-area-spread-model", (void*)&local_area_spread_model_new,
    local_area_spread_model_is_singleton},
  {"prophylactic-vaccination-model", (void*)&prophylactic_vaccination_model_new,
    prophylactic_vaccination_model_is_singleton},
  ...
  #ifndef WIN_DLL
  /* AR 1/27/10: state-table-writer.c does not compile on Windows */ 
  ...
  #ifndef WIN_DLL
    {"unit-state-monitor", (void*)&unit_state_monitor_new, unit_state_monitor_is_singleton},
  ...
  for (i = 0; i < nmodels; i++)
    {
...
#if DEBUG
      g_debug ("Model = <%p>", (void *) model_load_info);
#endif
      ...
      if (model != NULL)
      ...
      else
        {
...
#if DEBUG
          g_debug ("\"new\" function = <%p>", (void *) model_instantiation_fn);
#endif
          ...
          if (singleton)
            g_hash_table_insert (singletons, (gpointer) model_name, model);
