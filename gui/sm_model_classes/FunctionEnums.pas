...
-----------------
Begin: 2005/06/08
Last revision: $Date: 2011-03-24 03:46:44 $ $Author: areeves $
Version number: $Revision: 1.9.6.2 $
Project: NAADSM
...
interface
  ...
  type TSMChart = (
    ...
    DetProbObsVsTimeDead, // Rel
    DetProbReportClinVsFirstDetection, // Rel
    DetProbReportDeadVsFirstDetection, // Rel
