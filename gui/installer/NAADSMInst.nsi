...
installDir "$PROGRAMFILES\NAADSM 3.1.19"
...
page custom startDialog "" ": Start Dialog"
 Function startDialog
  ...
  NAADSM version 3.1.19 on your computer. \ 
...
WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\NAADSM3.1.19" \
                 "DisplayName" "NAADSM 3.1.19"
WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\NAADSM3.1.19" \
...
createShortCut "$SMPROGRAMS\NAADSM 3.1.19.lnk" "$INSTDIR\SpreadModel.exe"
sectionEnd
...
createShortCut "$DESKTOP\NAADSM 3.1.19.lnk" "$INSTDIR\SpreadModel.exe"
sectionEnd
...
section "Uninstall"
  ...
  ifFileExists "$SMPROGRAMS\NAADSM 3.1.19.lnk" DeleteSMlink DoNothingSM
  DeleteSMlink:
  Delete "$SMPROGRAMS\NAADSM 3.1.19.lnk"
  
  DoNothingSM:

  ifFileExists "$DESKTOP\NAADSM 3.1.19.lnk" DeleteDesktopLink DoNothingDESK
  DeleteDesktopLink:
  Delete "$DESKTOP\NAADSM 3.1.19.lnk"

  DoNothingDESK:

  RMDir $INSTDIR

  DeleteRegKey HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\NAADSM3.1.19"
