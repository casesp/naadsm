...
----------------------
Begin: 2007/04/20
Last revision: $Date: 2011-10-19 01:47:23 $ $Author: areeves $
Version number: $Revision: 1.14.2.18 $
Project: NAADSM
...
interface
  ...
  type TIterationOutputType = (
    ...
    EpiTscUDest,
    EpiTscADest,
    EpiTscUDead,  // new in 4.0
    EpiTscADead,  // new in 4.0

    // Cumulative totals for infections
    EpiInfcUIni,
    EpiInfcAIni,
    EpiInfcUAll, // "New" in 4.0.  NOT calculated!
    EpiInfcAAll, // "New" in 4.0.  NOT calculated!

    // Cumulative totals for cause of adequate exposure.  "New" in 4.0
    EpiAdqcUAir,
    EpiAdqcAAir,
    EpiAdqcUDir,
    EpiAdqcADir,
    ...
    EpiAdqcULcl,
    EpiAdqcALcl,
    EpiAdqcUAll, // Calculated
    EpiAdqcAAll, // Calculated
    ...
    // Cumulative totals for trace origins (new in 4.0.5)
    EpiTocUDirFwd,
    EpiTocUIndFwd,
    EpiTocUDirBack,
    EpiTocUIndBack,

    // Calculated cumulative totals for trace origins (new in 4.0.5)
    ...
    // Cumulative totals for detection of dead from disease (new in 4.0)
    EpiDetcUDead,
    EpiDetcADead,
    ...
    // Cumulative number of unique detected herds (modified in 4.0)
    EpiDetcUAll, // NOT calculated!
    EpiDetcAAll, // NOT calculated!

    // Cumulative number of unique herds detected in the dead from disease state (new in 4.0.9)
    EpiDetcUDeadAll, // NOT calculated!
    EpiDetcADeadAll, // NOT calculated!
    ...
    //AR:deadDV
    EpiDescUDcd, // New in 4.0.6
    EpiDescADcd, // New in 4.0.6
    EpiDescUDcdInDestrQueue, // New in 4.0.9
    EpiDescADcdInDestrQueue, // New in 4.0.9
    ...
    // Cumulative totals for dead from disease - new in 4.0
    EpiDeadcUIni,
    EpiDeadcAIni,
    EpiDeadcU,
    EpiDeadcA,
    EpiDeadcUInDestrQueue,
    EpiDeadcAInDestrQueue,
  ...
  type TDailyOutputType = (
    ...
    DEtsdUDest,
    DEtsdADest,
    DEtsdUDead, // new in 4.0
    DEtsdADead, // new in 4.0
    ...
    DEtscUDest,
    DEtscADest,
    DEtscUDead, // new in 4.0
    DEtscADead, // new in 4.0

    // New (incident) counts for infection
    DEinfnUAll,
    DEinfnAAll,
    ...
    // New (incident) counts for causes of adequate exposure
    DEadqnUAir,
    DEadqnAAir,
    DEadqnUDir,
    DEadqnADir,
    ...
    // New (incident) counts for trace origins (introduced in 4.0.5)
    DEtonUDirFwd,
    DEtonUIndFwd,
    DEtonUDirBack,
    DEtonUIndBack,

    // Running totals for trace origins (introduced in 4.0.5)
    DEtocUDirFwd,
    DEtocUIndFwd,
    DEtocUDirBack,
    DEtocUIndBack,
    ...
    // New (incident) counts for detection
    DEdetnUClin,
    DEdetnAClin,
    DEdetnUTest, // New in 3.2.0
    DEdetnATest, // New in 3.2.0
    DEdetnUDead, // New in 4.0.0
    DEdetnADead, // New in 4.0.0

    //AR:deadDV
    DEdetnUDeadD, // New in 4.0.6
    DEdetnADeadD, // New in 4.0.6
    DEdetnUDeadV, // New in 4.0.6
    DEdetnADeadV, // New in 4.0.6

    DEdetnUAll, // New in 4.0.0
    DEdetnAAll, // New in 4.0.0

    DEdetnUDeadAll, // New in 4.0.9
    DEdetnADeadAll, // New in 4.0.9

    // Running totals for detection
    DEdetcUClin,
    DEdetcAClin,
    DEdetcUTest, // New in 3.2.0
    DEdetcATest, // New in 3.2.0
    DEdetcUDead, // New in 4.0.0
    DEdetcADead, // New in 4.0.0

    //AR:deadDV
    DEdetcUDeadD, // New in 4.0.6
    DEdetcADeadD, // New in 4.0.6
    DEdetcUDeadV, // New in 4.0.6
    DEdetcADeadV, // New in 4.0.6

    DEdetcUAll, // New in 4.0.0
    DEdetcAAll, // New in 4.0.0
    ...
    DEdesnUDcd,
    DEdesnADcd,
    DEdesnUDcdInDestrQueue,
    DEdesnADcdInDestrQueue,
    ...
    //AR:deadDV
    DEdescUDcd, // New in 4.0.6
    DEdescADcd, // New in 4.0.6
    ...
    // New (incident) counts for dead from disease - new in 4.0
    DEdeadnU,
    DEdeadnA,

    // Running totals for dead from disease - new  in 4.0
    DEdeadcUIni,
    DEdeadcAIni,
    DEdeadcU,
    DEdeadcA,
...
implementation
  ...
  constructor TOutputDescriptionList.create();
    ...
    begin
      ...
      d := TOutputDescription.create( EpiTscUDead, 'tscUDead', tr( 'Number of units that are dead from disease over the course of an iteration' ), false, false );
      self.Add( integer( EpiTscUDead ), d );

      d := TOutputDescription.create( EpiTscADead, 'tscADead', tr( 'Total number of animals in all units that are dead from disease over the course of an iteration' ), false, false );
      self.Add( integer( EpiTscADead ), d );
      ...
      d := TOutputDescription.create( EpiInfcUAll, 'infcUAll', tr( 'Total number of units that become infected over the course of an iteration' ) + ' ' + tr ( '(not including initially infected units)' ), false, false );
      self.Add( integer( EpiInfcUAll ), d );

      d := TOutputDescription.create( EpiInfcAAll, 'infcAAll', tr( 'Total number of animals in units that become infected over the course of an iteration' ) + ' ' + tr ( '(not including initially infected units)' ), false, false );
      self.Add( integer( EpiInfcAAll ), d );

      // Running totals for causes of adequate exposure.
      d := TOutputDescription.create( EpiAdqcUAir, 'adqcUAir', tr( 'Number of units adequately exposed by airborne spread over the course of an iteration' ), false, false );
      self.Add( integer( EpiAdqcUAir ), d );

      d := TOutputDescription.create( EpiAdqcAAir, 'adqcAAir', tr( 'Number of animals in units adequately exposed by airborne spread over the course of an iteration' ), false, false );
      self.Add( integer( EpiAdqcAAir ), d );

      d := TOutputDescription.create( EpiAdqcUDir, 'adqcUDir', tr( 'Number of units adequately exposed by direct contact over the course of an iteration' ), false, false );
      self.Add( integer( EpiAdqcUDir ), d );

      d := TOutputDescription.create( EpiAdqcADir, 'adqcADir', tr( 'Number of animals in units adequately exposed by direct contact over the course of an iteration' ), false, false );
      self.Add( integer( EpiAdqcADir ), d );

      d := TOutputDescription.create( EpiAdqcUInd, 'adqcUInd', tr( 'Number of units adequately exposed by indirect contact over the course of an iteration' ), false, false );
      self.Add( integer( EpiAdqcUInd ), d );

      d := TOutputDescription.create( EpiAdqcAInd, 'adqcAInd', tr( 'Number of animals in units adequately exposed by indirect contact over the course of an iteration' ), false, false );
      self.Add( integer( EpiAdqcAInd ), d );

      d := TOutputDescription.create( EpiAdqcULcl, 'adqcULcl', tr( 'Number of units adequately exposed by local-area spread over the course of an iteration' ), false, false );
      self.Add( integer( EpiAdqcULcl ), d );

      d := TOutputDescription.create( EpiAdqcALcl, 'adqcALcl', tr( 'Number of animals in units adequately exposed by local-area spread over the course of an iteration' ), false, false );
      self.Add( integer( EpiAdqcALcl ), d );

      d := TOutputDescription.create( EpiAdqcUAll, 'adqcUAll', tr( 'Total number of units adequately exposed over the course of an iteration' ), true, false );
      self.Add( integer( EpiAdqcUAll ), d );

      d := TOutputDescription.create( EpiAdqcAAll, 'adqcAAll', tr( 'Total number of animals in units adequately exposed over the course of an iteration' ), true, false );
      self.Add( integer( EpiAdqcAAll ), d );
      ...
      d := TOutputDescription.create( EpiDetcUDead, 'detcUDead', tr( 'Number of units detected dead from disease by self-reporting over the course of an iteration' ), false, false );
      self.Add( integer( EpiDetcUDead ), d );

      d := TOutputDescription.create( EpiDetcADead, 'detcADead', tr( 'Total number of animals in all units detected dead from disease by self-reporting over the course of an iteration' ), false, false );
      self.Add( integer( EpiDetcADead ), d );

      //AR:deadDV
      d := TOutputDescription.create( EpiDetcUDeadD, 'detcUDeadD', tr( 'Number of units detected dead from disease by a destruction team over the course of an iteration' ), false, false );
      self.Add( integer( EpiDetcUDeadD ), d );

      d := TOutputDescription.create( EpiDetcADeadD, 'detcADeadD', tr( 'Total number of animals in all units detected dead from disease by a destruction team over the course of an iteration' ), false, false );
      self.Add( integer( EpiDetcADeadD ), d );

       d := TOutputDescription.create( EpiDetcUDeadV, 'detcUDeadV', tr( 'Number of units detected dead from disease by a vaccination team over the course of an iteration' ), false, false );
      self.Add( integer( EpiDetcUDeadV ), d );

      d := TOutputDescription.create( EpiDetcADeadV, 'detcADeadV', tr( 'Total number of animals in all units detected dead from disease by a vaccination team over the course of an iteration' ), false, false );
      self.Add( integer( EpiDetcADeadV ), d );

      d := TOutputDescription.create( EpiDetcUDeadAll, 'detcUDeadAll', tr( 'Number of units that were not detected until they entered the the "dead from disease" state over the course of the iteration' ), false, false );
      self.Add( integer( EpiDetcUDeadAll ), d );

      d := TOutputDescription.create( EpiDetcADeadAll, 'detcADeadAll', tr( 'Total number of animals in units that were not detected until they entered the "dead from disease" state over the course of the iteration' ), false, false );
      self.Add( integer( EpiDetcADeadAll ), d );

      d := TOutputDescription.create( EpiDetcUAll, 'detcUAll', tr( 'Total number of unique units detected for any reason over the course of the iteration' ), false, false );
      self.Add( integer( EpiDetcUAll ), d );

      d := TOutputDescription.create( EpiDetcAAll, 'detcAAll', tr( 'Total number of animals in unique units detected for any reason over the course of the iteration' ), false, false );
      ...
      //AR:deadDV
      d := TOutputDescription.create( EpiDescUDcd, 'descUDcd', tr( 'Number of units that required only disposal, cleaning, and disinfection over the course of an iteration' ), false, false );
      self.Add( integer( EpiDescUDcd ), d );

      d := TOutputDescription.create( EpiDescADcd, 'descADcd', tr( 'Total number of animals in units that required only disposal, cleaning, and disinfection over the course of an iteration' ), false, false );
      self.Add( integer( EpiDescADcd ), d );

      d := TOutputDescription.create( EpiDescUDcdInDestrQueue, 'descUDcdInDestrQueue', tr( 'Number of units that died from disease while in the destruction queue and required only disposal, cleaning, and disinfection over the course of an iteration' ), false, false );
      self.Add( integer( EpiDescUDcdInDestrQueue ), d );

      d := TOutputDescription.create( EpiDescADcdInDestrQueue, 'descADcdInDestrQueue', tr( 'Total number of animals in units that died from disease while in the destruction queue and required only disposal, cleaning, and disinfection over the course of an iteration' ), false, false );
      self.Add( integer( EpiDescADcdInDestrQueue ), d );


      d := TOutputDescription.create( EpiDescUAll, 'descUAll', tr( 'Number of units destroyed for any reason (including units requiring only disposal, cleaning, and disinfection) over the course of an iteration' ) + ' ' + tr ( '(not including initially destroyed units)' ), true, false );
      self.Add( integer( EpiDescUAll ), d );

      d := TOutputDescription.create( EpiDescAAll, 'descAAll', tr( 'Total number of animals in units destroyed for any reason (including units requiring only disposal, cleaning, and disinfection) over the course of an iteration' ) + ' ' + tr ( '(not including initially destroyed units)' ), true, false );
      ...
      *)
      ...
      // Cumulative totals for dead from disease
      d := TOutputDescription.create( EpiDeadcUIni, 'deadcUIni', tr( 'Number of units dead from disease prior to the start of the simulation' ), false, false );
      self.Add( integer( EpiDeadcUIni ), d );

      d := TOutputDescription.create( EpiDeadcAIni, 'deadcAIni', tr( 'Total number of animals in units dead from disease prior to the start of the simulation' ), false, false );
      self.Add( integer( EpiDeadcAIni ), d );

      d := TOutputDescription.create( EpiDeadcU, 'deadcU', tr( 'Number of units dead from disease over the course of an iteration' ), false, false );
      self.Add( integer( EpiDeadcU ), d );

      d := TOutputDescription.create( EpiDeadcA, 'deadcA', tr( 'Total number of animals in all units dead from disease over the course of an iteration' ), false, false );
      self.Add( integer( EpiDeadcA ), d );

      d := TOutputDescription.create( EpiDeadcUInDestrQueue, 'deadcUInDestrQueue', tr( 'Number of units that died from disease while awaiting destruction over the course of an iteration' ), false, false );
      self.Add( integer( EpiDeadcUInDestrQueue ), d );

      d := TOutputDescription.create( EpiDeadcAInDestrQueue, 'deadcAInDestrQueue', tr( 'Total number of animals in all units that died from disease while awaiting destruction over the course of an iteration' ), false, false );
      self.Add( integer( EpiDeadcAInDestrQueue ), d );
