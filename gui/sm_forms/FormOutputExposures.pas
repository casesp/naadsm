...
---------------------------
Begin: 2005/02/01
Last revision: $Date: 2011-07-21 21:31:51 $ $Author: rhupalo $
Version: $Revision: 1.30.10.3 $
Project: NAADSM
    ...
    begin
      ...
      with self do
        begin
          ...
          cboExposureType.Items[3] := tr( 'Local-area exposure' );
          cboExposureType.Items[4] := tr( 'Trace forward, direct' );
          cboExposureType.Items[5] := tr( 'Trace forward, indirect' );
          cboExposureType.Items[6] := tr( 'Trace back, direct' );
          cboExposureType.Items[7] := tr( 'Trace back, indirect' );
        ...
        // Filtering by source type is taken care of by a different mechanism
          ...
          begin
            ...
            case cboExposureType.ItemIndex of
              ...
              3: // Local-area spread
                begin
                  stgGrid.SearchOptions.SearchText := tr( 'Local-area exposure' );
                  stgGrid.SearchOptions.Filtered := _filtering;
                end
              ;
              4: // Trace forward, direct
                begin
                  stgGrid.SearchOptions.SearchText := tr( 'Trace forward, direct' );
                  stgGrid.SearchOptions.Filtered := _filtering;
                end
              ;
              5: // Trace forward, indirect
                begin
