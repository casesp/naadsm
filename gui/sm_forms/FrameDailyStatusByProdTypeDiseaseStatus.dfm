inherited FrameDailyStatusByProdTypeDiseaseStatus: TFrameDailyStatusByProdTypeDiseaseStatus
  Width = 728
  Height = 452
  ...
  object chtOutputs: TChart
    ...
    object SeriesDeadFromDisease: TLineSeries
      Marks.ArrowLength = 8
      Marks.Visible = False
      SeriesColor = clGreen
      Title = 'Dead'
  ...
  object pnlCheckBoxes: TPanel
    ...
    object cbxDeadFromDisease: TCheckBox
      Left = 8
      Top = 168
      Width = 113
      Height = 17
      Caption = 'Dead from Disease'
      Checked = True
      State = cbChecked
      TabOrder = 14
      OnClick = cbxClick
    end
    object lineDeadFromDisease: TPanel
      Left = 25
      Top = 184
      Width = 96
      Height = 2
