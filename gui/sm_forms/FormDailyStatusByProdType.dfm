inherited FormDailyStatusByProdType: TFormDailyStatusByProdType
  ...
  object pcCharts: TPageControl [2]
    ...
    Width = 747
    Height = 455
    ActivePage = tsDiseaseStatus
    Align = alClient
    TabOrder = 2
    object tsDiseaseStatus: TTabSheet
      Caption = 'Disease Status'
      inline fraDiseaseStatus: TFrameDailyStatusByProdTypeDiseaseStatus
        Left = 0
        Top = 0
        Width = 739
        Height = 427
    ...
    object tsControlStatus: TTabSheet
      ...
      ImageIndex = 1
      inline fraControlStatus: TFrameDailyStatusByProdTypeControlStatus
        Left = 0
        Top = 0
        Width = 739
        Height = 427
    ...
    object tsDetectionStatus: TTabSheet
      ...
      ImageIndex = 2
      inline fraDetectionStatus: TFrameDailyStatusByProdTypeDetectionStatus
        Left = 0
        Top = 0
        Width = 739
        Height = 427
