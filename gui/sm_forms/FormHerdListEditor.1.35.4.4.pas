...
Version number: $Revision: 1.35.4.4 $
Project: NAADSM
...
interface
  ...
  type TFormHerdListEditor = class( TFormSMWizardBase )
    ...
    protected
      ...
      function createListFromFile( const fileName: string; fileFormat: integer ): THerdList;
...
//-----------------------------------------------------------------------------
  ...
  function TFormHerdListEditor.createListFromFile( const fileName: string; fileFormat: integer ): THerdList;
    var
      h: THerd;
    ...
    begin
      ...
      then
        success := localHerdList.importFromFile( fileName, fileFormat, @errMsg, fn1, fn2, fn3, false )
