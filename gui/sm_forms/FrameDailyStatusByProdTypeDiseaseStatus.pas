{*
FrameDailyStatusByProdTypeDiseaseStatus.pas/dfm
-----------------------------------------------
Begin: 2005/12/13
Last revision: $Date: 2010-06-24 03:10:14 $ $Author: areeves $
Version number: $Revision: 1.4.2.1 $
Project: NAADSM
...
unit FrameDailyStatusByProdTypeDiseaseStatus;
...
interface
  ...
  type
    TFrameDailyStatusByProdTypeDiseaseStatus = class(TFrameChartBase)
      ...
      SeriesDeadFromDisease: TLineSeries;
...
{$R *.dfm}
  ...
  constructor TFrameDailyStatusByProdTypeDiseaseStatus.create( AOwner: TComponent );
    begin
      ...
      cbxDeadFromDisease.Checked := true;
  ...
  procedure TFrameDailyStatusByProdTypeDiseaseStatus.translateUI();
    begin
      ...
      with self do
        begin
          ...
          cbxDeadFromDisease.Caption := tr( 'Dead from disease' );
      ...
      with self do
        begin
          ...
          chtOutputs.Series[5].Title := tr( 'Dead from disease' );
          chtOutputs.Series[6].Title := tr( 'VacImmune' );
          chtOutputs.Series[7].Title := tr( 'Destroyed' );
  ...
  procedure TFrameDailyStatusByProdTypeDiseaseStatus.translateUIManual();
    begin
      with self do
        begin
  ...
  procedure TFrameDailyStatusByProdTypeDiseaseStatus.initializeChartColors;
    begin
      ...
      chtOutputs.Series[5].SeriesColor := naadsmDiseaseStateColor(NAADSMStateDeadFromDisease);
      chtOutputs.Series[6].SeriesColor := naadsmDiseaseStateColor(NAADSMStateVaccineImmune);
      chtOutputs.Series[7].SeriesColor := naadsmDiseaseStateColor(NAADSMStateDestroyed);
      ...
      lineDeadFromDisease.Color := naadsmDiseaseStateColor(NAADSMStateDeadFromDisease);
  ...
  procedure TFrameDailyStatusByProdTypeDiseaseStatus.drawAllSeries(day: integer; DailyData: TSMDailyOutput );
    begin
      ...
      SeriesDeadFromDisease.AddXY( day, DailyData.tsdUDead );
  ...
  procedure TFrameDailyStatusByProdTypeDiseaseStatus.fixTChartBug();
    var
  ...
  procedure TFrameDailyStatusByProdTypeDiseaseStatus.reset();
    begin
      SeriesSusc.Clear();
      SeriesLatent.Clear;
  ...
  procedure TFrameDailyStatusByProdTypeDiseaseStatus.setHorizAxisAutomatic();
    begin
      ...
      SeriesDeadFromDisease.GetHorizAxis.Automatic := true;
  ...
  procedure TFrameDailyStatusByProdTypeDiseaseStatus.setHorizAxisMinMax(min, max: double);
    begin
      ...
      SeriesDeadFromDisease.GetHorizAxis.SetMinMax( min, max );
  ...
  procedure TFrameDailyStatusByProdTypeDiseaseStatus.setVertAxisAutomatic();
    begin
      ...
      SeriesDeadFromDisease.GetVertAxis.Automatic := true;
  ...
  procedure TFrameDailyStatusByProdTypeDiseaseStatus.setVertAxisMinMax(min, max: double);
    begin
      ...
      SeriesDeadFromDisease.GetVertAxis.SetMinMax( min, max );
  ...
  function TFrameDailyStatusByProdTypeDiseaseStatus.seriesMaxY(): double;
    var
      i: integer;
    begin
      result := 0.0;
  ...
  procedure TFrameDailyStatusByProdTypeDiseaseStatus.drawFirstDetection( const day: integer );
    begin
      seriesPDetection.Clear();
  ...
  procedure TFrameDailyStatusByProdTypeDiseaseStatus.drawFirstDestruction( const day: integer );
    begin
      seriesPDestruction.Clear();
  ...
  procedure TFrameDailyStatusByProdTypeDiseaseStatus.drawFirstVaccination( const day: integer );
    begin
      seriesPVaccination.Clear();
  ...
  procedure TFrameDailyStatusByProdTypeDiseaseStatus.drawOutbreakEnd( const day: integer );
    begin
      seriesPOver.Clear();
  ...
  procedure TFrameDailyStatusByProdTypeDiseaseStatus.redrawEvents();
    begin
  ...
  procedure TFrameDailyStatusByProdTypeDiseaseStatus.cbxClick(Sender: TObject);
    begin
      if( _meCreated ) then
        begin
          if( nil <> _myMainForm ) then
            begin
              ...
              SeriesDeadFromDisease.Active := cbxDeadFromDisease.Checked;
  ...
  procedure TFrameDailyStatusByProdTypeDiseaseStatus.cbxThreeDClick(Sender: TObject);
    begin
