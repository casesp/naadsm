{*
FrameDailyStatusByProdTypeControlStatus.pas/dfm
-----------------------------------------------
Begin: 2005/12/13
Last revision: $Date: 2010-06-24 03:10:13 $ $Author: areeves $
Version number: $Revision: 1.3.2.2 $
Project: NAADSM
...
unit FrameDailyStatusByProdTypeControlStatus;
...
interface
  ...
  type
    TFrameDailyStatusByProdTypeControlStatus = class(TFrameChartBase)
...
{$R *.dfm}
  ...
  constructor TFrameDailyStatusByProdTypeControlStatus.create( AOwner: TComponent );
    begin
  ...
  procedure TFrameDailyStatusByProdTypeControlStatus.translateUI();
    begin
  ...
  procedure TFrameDailyStatusByProdTypeControlStatus.translateUIManual();
    begin
    end
  ;


  procedure TFrameDailyStatusByProdTypeControlStatus.initializeChartColors();
    begin
  ...
  procedure TFrameDailyStatusByProdTypeControlStatus.drawAllSeries(day: integer; DailyData: TSMDailyOutput );
    begin
  ...
  procedure TFrameDailyStatusByProdTypeControlStatus.fixTChartBug();
    var
  ...
  procedure TFrameDailyStatusByProdTypeControlStatus.reset();
    begin
...
procedure TFrameDailyStatusByProdTypeControlStatus.setHorizAxisAutomatic();
    begin
  ...
  procedure TFrameDailyStatusByProdTypeControlStatus.setHorizAxisMinMax(min, max: double);
    begin
  ...
  procedure TFrameDailyStatusByProdTypeControlStatus.setVertAxisAutomatic();
    begin
  ...
  procedure TFrameDailyStatusByProdTypeControlStatus.setVertAxisMinMax(min, max: double);
    begin
  ...
  function TFrameDailyStatusByProdTypeControlStatus.seriesMaxY(): double;
    var
      i: integer;
    begin
      result := 0.0;
  ...
  procedure TFrameDailyStatusByProdTypeControlStatus.drawFirstDetection( const day: integer );
    begin
      seriesPDetection.Clear();
  ...
  procedure TFrameDailyStatusByProdTypeControlStatus.drawFirstDestruction( const day: integer );
    begin
      seriesPDestruction.Clear();
  ...
  procedure TFrameDailyStatusByProdTypeControlStatus.drawFirstVaccination( const day: integer );
    begin
      seriesPVaccination.Clear();
  ...
  procedure TFrameDailyStatusByProdTypeControlStatus.drawOutbreakEnd( const day: integer );
    begin
      seriesPOver.Clear();
  ...
  procedure TFrameDailyStatusByProdTypeControlStatus.redrawEvents();
    begin
  ...
  procedure TFrameDailyStatusByProdTypeControlStatus.cbxClick(Sender: TObject);
    begin
      if( _meCreated ) then
        begin
  ...
  procedure TFrameDailyStatusByProdTypeControlStatus.cbxThreeDClick(Sender: TObject);
    begin
  ...
  procedure TFrameDailyStatusByProdTypeControlStatus.cbxCumulativeClick(Sender: TObject);
    begin
      inherited;
