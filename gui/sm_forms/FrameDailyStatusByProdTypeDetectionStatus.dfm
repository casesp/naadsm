inherited FrameDailyStatusByProdTypeDetectionStatus: TFrameDailyStatusByProdTypeDetectionStatus
  Width = 728
  Height = 452
  ...
  object chtOutputs: TChart
    ...
    object SeriesDetectedDeadFromDisease: TLineSeries
      Marks.ArrowLength = 0
      Marks.Frame.Visible = False
      Marks.Transparent = True
      Marks.Visible = False
      SeriesColor = clGreen
      Title = 'Detected dead from disease'
      Pointer.InflateMargins = True
      Pointer.Style = psRectangle
      Pointer.Visible = False
      XValues.DateTime = False
  ...
  object pnlCheckBoxes: TPanel
    ...
    object cbxDetectedDeadFromDisease: TCheckBox
      Left = 8
      Top = 232
      Width = 134
      Height = 17
      Caption = 'Detected dead'
      Checked = True
      State = cbChecked
      TabOrder = 7
      OnClick = cbxClick
    end
    object lineDetectedDeadFromDisease: TPanel
      Left = 25
      Top = 248
      Width = 96
      Height = 2
