...
------------------------
Begin: 2005/06/08
Last revision: $Date: 2011-10-18 23:30:32 $ $Author: areeves $
Version: $Revision: 1.34.10.2 $
Project: NAADSM
    ...
    begin
      ...
      with self do
        begin
          ...
          lblMinTimeBetwVacc.Caption := tr( 'Minimum time that must elapse after vaccination of a unit of this production type before that unit can be queued for another vaccination (days):' );
          imgPdf.Hint := tr( 'This parameter is a probability density function' );
          cbxVaccinateDetected.Caption := tr( 'Vaccinate detected units of this production type when they occur in vaccination rings' );
        end
      ;
    end
  ;
