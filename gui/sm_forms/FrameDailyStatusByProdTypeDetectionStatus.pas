{*
FrameDailyStatusByProdTypeDetectionStatus.pas/dfm
-------------------------------------------------
Begin: 2005/12/13
Last revision: $Date: 2011-08-23 21:40:53 $ $Author: areeves $
Version number: $Revision: 1.2.2.5 $
Project: NAADSM
...
unit FrameDailyStatusByProdTypeDetectionStatus;
...
interface
  ...
  type
    TFrameDailyStatusByProdTypeDetectionStatus = class(TFrameChartBase)
      ...
      SeriesDetectedDeadFromDisease: TLineSeries;
      ...
      cbxDetectedDeadFromDisease: TCheckBox;
      lineDetectedDeadFromDisease: TPanel;
...
{$R *.dfm}
  ...
  constructor TFrameDailyStatusByProdTypeDetectionStatus.create( AOwner: TComponent );
    begin
      ...
      cbxDetectedDeadFromDisease.Checked := true;
  ...
  procedure TFrameDailyStatusByProdTypeDetectionStatus.translateUI();
    begin
      ...
      with self do
        begin
          ...
          cbxDetectedDeadFromDisease.Caption := tr( 'Detected dead' );
        end
      ;
      ...
      with self do
        begin
          ...
          chtOutputs.Series[7].Title := tr( 'Detected dead from disease' );

          chtOutputs.Series[8].Title := tr( 'First Detection' );
          chtOutputs.Series[9].Title := tr( 'First destruction' );
          chtOutputs.Series[10].Title := tr( 'First vaccination' );
          chtOutputs.Series[11].Title := tr( 'Outbreak over' );
        end
      ;
  ...
  procedure TFrameDailyStatusByProdTypeDetectionStatus.translateUIManual();
    begin
    end
  ;


  procedure TFrameDailyStatusByProdTypeDetectionStatus.initializeChartColors();
    begin
      ...
      chtOutputs.Series[7].SeriesColor := detectionStatusColor(dsDetectedDeadFromDisease);
      ...
      (chtOutputs.Series[8] as TPointSeries).Pointer.Brush.Color := eventStatusColor(esFirstDetection);
      (chtOutputs.Series[9] as TPointSeries).Pointer.Brush.Color := eventStatusColor(esFirstDestruction);
      (chtOutputs.Series[10] as TPointSeries).Pointer.Brush.Color := eventStatusColor(esFirstVaccination);
      (chtOutputs.Series[11] as TPointSeries).Pointer.Brush.Color := eventStatusColor(esOutbreakOver);
      ...
      lineDetectedDeadFromDisease.Color := detectionStatusColor(dsDetectedDeadFromDisease);
    end
  ;
  ...
  procedure TFrameDailyStatusByProdTypeDetectionStatus.drawAllSeries( day: integer; DailyData: TSMDailyOutput );
    begin
      if( ( not cbxCumulative.Checked ) or ( 0 = SeriesExamined.YValues.Count ) ) then
        begin
          ...
          //AR:deadDV - replace line
          SeriesDetectedDeadFromDisease.AddXY( day, Dailydata.detnUDead + Dailydata.detnUDeadD + Dailydata.detnUDeadV );
        end
      else
        begin
          ...
          //AR:deadDV - replace line
          SeriesDetectedDeadFromDisease.AddXY( day, Dailydata.detnUDead + Dailydata.detnUDeadD + Dailydata.detnUDeadV + SeriesDetectedDeadFromDisease.YValues.Last );
        end
      ;
  ...
  procedure TFrameDailyStatusByProdTypeDetectionStatus.fixTChartBug();
    var
  ...
  procedure TFrameDailyStatusByProdTypeDetectionStatus.reset();
    begin
      ...
      SeriesDetectedDeadFromDisease.Clear();
  ...
  procedure TFrameDailyStatusByProdTypeDetectionStatus.setHorizAxisAutomatic();
    begin
      ...
      SeriesDetectedDeadFromDisease.GetHorizAxis.Automatic := true;
  ...
  procedure TFrameDailyStatusByProdTypeDetectionStatus.setHorizAxisMinMax(min, max: double);
    begin
      ...
      SeriesDetectedDeadFromDisease.GetHorizAxis.SetMinMax( min, max );
  ...
  procedure TFrameDailyStatusByProdTypeDetectionStatus.setVertAxisAutomatic();
    begin
      ...
      SeriesDetectedDeadFromDisease.GetVertAxis.Automatic := true;
  ...
  procedure TFrameDailyStatusByProdTypeDetectionStatus.setVertAxisMinMax(min, max: double);
    begin
      ...
      SeriesDetectedDeadFromDisease.GetVertAxis.SetMinMax( min, max );
  ...
  function TFrameDailyStatusByProdTypeDetectionStatus.seriesMaxY(): double;
    var
      i: integer;
    begin
      result := 0.0;
  ...
  procedure TFrameDailyStatusByProdTypeDetectionStatus.drawFirstDetection( const day: integer );
    begin
      seriesPDetection.Clear();
  ...
  procedure TFrameDailyStatusByProdTypeDetectionStatus.drawFirstDestruction( const day: integer );
    begin
      seriesPDestruction.Clear();
  ...
  procedure TFrameDailyStatusByProdTypeDetectionStatus.drawFirstVaccination( const day: integer );
    begin
      seriesPVaccination.Clear();
  ...
  procedure TFrameDailyStatusByProdTypeDetectionStatus.drawOutbreakEnd( const day: integer );
    begin
      seriesPOver.Clear();
  ...
  procedure TFrameDailyStatusByProdTypeDetectionStatus.redrawEvents();
    begin
  ...
  procedure TFrameDailyStatusByProdTypeDetectionStatus.cbxClick(Sender: TObject);
    begin
      if( _meCreated ) then
        begin
          if( nil <> _myMainForm ) then
            begin
              ...
              SeriesDetectedDeadFromDisease.Active := cbxDetectedDeadFromDisease.Checked;
  ...
  procedure TFrameDailyStatusByProdTypeDetectionStatus.cbxThreeDClick(Sender: TObject);
    begin
  ...
  procedure TFrameDailyStatusByProdTypeDetectionStatus.cbxCumulativeClick(Sender: TObject);
    begin
      inherited;
