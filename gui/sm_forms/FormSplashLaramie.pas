unit FormSplashLaramie;

(*
FormSplashLaramie.pas/dfm
--------------------------
Begin: 2008/10/21
...
interface
  ...
  type TFormSplashLaramie = class( TForm )
  		pnlWholeForm: TPanel;
      pnlAppTitle: TPanel;
      lblVersion: TLabel;
      Timer1: TTimer;
...
{$R *.dfm}
  ...
  constructor TFormSplashLaramie.create( AOwner: TComponent );
    begin
  ...
  procedure TFormSplashLaramie.translateUI();
    begin
      // This function was generated automatically by Caption Collector 0.6.0.
      // Generation date: Mon Feb 25 12:56:54 2008
      // File name: C:/Documents and Settings/apreeves/My Documents/NAADSM/Interface-Fremont/sm_forms/FormSplashLaramie.dfm
  ...
  ;
 	...
 	procedure TFormSplashLaramie.FormCreate(Sender: TObject);
 		begin
  ...
  destructor TFormSplashLaramie.destroy();
    begin
      frmSplash := nil;
      inherited destroy();
    end
  ...
  procedure TFormSplashLaramie.FormClose(Sender: TObject; var Action: TCloseAction);
    begin
      Action := caFree;
    end
  ;
  ...
  procedure TFormSplashLaramie.timerTimeout(Sender: TObject);
    begin
      close();
    end
  ;
