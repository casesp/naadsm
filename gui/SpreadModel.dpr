...
----------------
Begin: 2004/07/15
Last revision: $Date: 2012-10-01 21:33:51 $ $Author: areeves $
Version: $Revision: 1.169.6.9 $
Project: NAADSM
...
uses
  ...
  SMDatabaseFnsVers3 in 'sm_database\SMDatabaseFnsVers3.pas',
  DiseaseParams in 'sm_model_classes\DiseaseParams.pas',
  VaccinationParams in 'sm_model_classes\VaccinationParams.pas',
  LocalAreaSpreadParams in 'sm_model_classes\LocalAreaSpreadParams.pas',
  ...
  {$IFNDEF CONSOLEAPP}
    ...
    FormLocalAreaSpread in 'sm_forms\FormLocalAreaSpread.pas' {FormLocalAreaSpread},
    FrameAirborneOrLocalAreaSpread in 'sm_forms\FrameAirborneOrLocalAreaSpread.pas' {FrameAirborneOrLocalAreaSpread: TFrame},
    ...
    FrameDailyStatusByProdTypeDiseaseStatus in 'sm_forms\FrameDailyStatusByProdTypeDiseaseStatus.pas' {FrameDailyStatusByProdTypeDiseaseStatus: TFrame},
    FrameDailyStatusByProdTypeDetectionStatus in 'sm_forms\FrameDailyStatusByProdTypeDetectionStatus.pas' {FrameDailyStatusByProdTypeDetectionStatus: TFrame},
    FrameDailyStatusByProdTypeControlStatus in 'sm_forms\FrameDailyStatusByProdTypeControlStatus.pas' {FrameDailyStatusByProdTypeControlStatus: TFrame},    
...
var
  ...
  function requiredDllsOK( var msg: string ): boolean;
    ...
    begin
      ...
      dbcout( 'FIX ME: Remote messenger is temporarily disabled.', true );
      remoteLoaded := true;
      (*
  ...
  procedure launchGUI( cmdParams: TCmdLine {fileName: string = ''} );
    ...
    begin
      ...
      // Set up the window for displaying warnings generated by the DLL
      //---------------------------------------------------------------
      // frmDllWarnings is declared in NAADSMLibrary.pas.  With any luck, it will never be used.
